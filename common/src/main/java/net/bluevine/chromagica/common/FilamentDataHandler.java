...
import net.bluevine.chromagica.common.model.RGBCoefficientsAdapter;
import net.bluevine.chromagica.common.model.RGBColorAdapter;
import net.bluevine.chromagica.common.model.RGBColorMapAdapter;
